...
import { r200, r400, r404 } from "../utils/response";
  ...
  const newStaff = async (req: Request, res: Response) => {
  ...
  const changeStatusStaff = async (req: Request, res: Response) => {
    const staff: Staff = res.locals.staffUpdate
...
export default {changeStatusStaff, editStaff, newStaff, listAll};
